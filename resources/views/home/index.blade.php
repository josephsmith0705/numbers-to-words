...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class="mt-5 px-2" style="width: 100%; text-align: center;">
            <h1 class="display-1">Number to Word Converter</h1>
        </div>
            ...
            @if(!isset($result))
                <form method="POST" action="/">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="convert-query" placeholder="Enter number or word" name="convert_query" style="text-align: center;">
                    </div>
